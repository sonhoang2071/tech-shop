<div class="py-3 border shadow " style="height: 100%">
    <div class="container" style="height: 100%" >
        ...
        <ul class="nav flex-column mb-auto">
            <li class="nav-item">
                <a class="nav-link rounded-pill" href="{{route('admin.homeAdmin')}}"><i class="fa-solid fa-house"></i>Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link rounded-pill" href="{{route('admin.product.list')}}"><i class="fa-brands fa-product-hunt"></i>Product</a>
            </li>
            <li class="nav-item">
