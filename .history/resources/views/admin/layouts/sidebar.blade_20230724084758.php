<div class="py-3 border shadow" style="height: 100%; position: fixed;width:16.66666667%">
    <div class="container" style="height: 100%" >
        ...
        <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link rounded-pill" href="{{route('admin.orders.list')}}"><i class="fa-solid fa-bag-shopping"></i>Order</a>
            </li>
            <li class="nav-item mb-2">
                <a class="nav-link rounded-pill" href="{{route('admin.users.list')}}"><i class="fa-solid fa-user"></i>User</a>
            </li>
            <li class="nav-item mb-2">
                <a class="nav-link rounded-pill" href="{{route('admin.reports.list')}}"><i class="fa-solid fa-bookmark"></i>Statistical Report</a>
            </li>
            <li class="nav-item mb-2 log-out" >
                <a class="nav-link link-logout" href="{{route('client.list')}}"><i class="fa-solid fa-arrow-right-from-bracket"></i>Back Home</a>
            </li>
        </ul>
