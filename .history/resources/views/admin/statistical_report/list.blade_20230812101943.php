...
@section('content')
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
        <script>
            ...
            var my_chart_3  = new Chart(myChart3, {
                    type: 'line',
                    data: {
                        labels: [],
                        datasets: [{
                        label: 'Profit of Orders',
                        data: [],
                        borderWidth: 1
                        }]
                    },
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    url: "http://127.0.0.1:8000/admin/reports/gdata3",
                }).done(function(data, err) {
                    var lbl = [];
                    var dat = [];
                    ...
                    my_chart_3.data.labels = lbl;
                    my_chart_3.data.datasets[0].data = dat;
