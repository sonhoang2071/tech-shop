...
<section class="log-in-page">
    <div class="main-page shadow">
      ...
      <form class="form" action="{{ route('login') }}" method="POST">
        ...
        <input id="password" type="password" class="input-field @error('password') is-invalid @enderror" name="password"  autocomplete="current-password" placeholder="Nhập địa chỉ...">
        @error('password')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
