<div class="">
    ...
    <div class="head2">
        <div class="main-nav">
            ...
            <div class="block-cart" id="sonhoang2071">
                @guest
                @if (Route::has('login'))
                ...
                @else
                    <div class="nav-item dropdown" >
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" id="menuUser">
...
<style>
    ...
    #sonhoang2071:hover div#menuUser{
            display: block;
    }
    a {
        text-decoration: none;
