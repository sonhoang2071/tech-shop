                ...
                @else
                        ...
                        <div class="dropdown-content" id="menuUser-content" >
                            ...
                            @else
                                ...
                                <a href="{{route('getOrderHistory')}}" style="display: flex">Lịch sử đơn hàng<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i></a>
                            @endif
                            <a href="{{ route('logout') }}"
