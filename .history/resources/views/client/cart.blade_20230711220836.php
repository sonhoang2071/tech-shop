...
@section('content')
                    ...
                    <div class="row r-item">
                        ...
                        <div class="col-3">
                            <div class="qty-container">
                                ...
                                <button class="qty-btn-plus btn-light" type="button" onclick="decreaseItem({{$item['productInfo']->id}})"><i class="fa fa-plus" ></i></button>
                            </div>
                        </div>
    ...
    <script>
        ...
        function decreaseItem(id){
            var $n = $("#item-cart-"+id).val()
            $n.val(Number($n.val())+2 );
