                    ...
                    <div class="content-1">
                        ...
                        <div class="dropdown-content-2">
                            @foreach (getAllBRand() as $item)
                                <a href="{{route('client.getProWith',['cate'=>$item->tenHieu])}}" style="display: flex">{{$item->tenHieu}}<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i>
                                </a>
                            @endforeach
                        </div>
                    </div>
