...
@section('content')
    <div class="wrap">
        <div class="row">
            <div class="col-6 block-img c1 parent" >
                <div class="child">
                    <img src="{{asset($productDetail->hinhAnh)}}" alt="" class="img-pro" >
                </div>
            </div>
            <div class="col-5 c2">
                <div class="row r1">
    ...
    <script>
        ...
        const block_img = document.querySelector(".block-img");
        block_img.addEventListener("click", handleImg);
        function handleImg(e) {
            ...
            document.addEventListener("click", (e) => {
                if (!lightBoxContent.contains(e.target) && !img.contains(e.target)) {
                lightBox.remove();
                }
            });
        }
