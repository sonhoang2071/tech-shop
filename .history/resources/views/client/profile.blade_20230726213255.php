                      ...
                      <div class="row">
                        ...
                        <div class=" col-md-9 col-lg-9 ">
                          <table class="table table-user-information">
                            <tbody>
                                <div class="row" style="align-items: center;padding-bottom: 12px;border-bottom: 1px solid grey;">
                                    <span>Name</span>
                                    <input type="checkbox" onclick="myFunction()">
                                    <input id="name" class="form-control" type="text" value="{{Auth::user()->name}}" disabled style="width-"></div>
                              <tr>
                                <td>Date of Birth</td>
