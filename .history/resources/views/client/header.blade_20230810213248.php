        ...
        <div class="main-nav">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <div class="content-1">
                        ...
                        <div class="dropdown-content-2">
                            @foreach (getAllCateGory() as $item)
                                <a href="{{route('client.getProWithCate',['cate'=>$item->tenLoai])}}" style="display: flex">{{$item->tenLoai}}<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i>
                                </a>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="content-1">
                        <a href="">Thương hiệu sản phẩm</a>
                        <div class="dropdown-content-2">
                            @foreach (getAllBRand() as $item)
                                <a href="{{route('client.getProWithBrand',['brand'=>$item->tenHieu])}}" style="display: flex">{{$item->tenHieu}}<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i>
                                </a>
                            @endforeach
                        </div>
                    </div>
            ...
            <form action="" method="GET" style="margin-bottom: 0;">
                <div class="" style="display: flex;">
                    ...
                    <input type="search" name="search" id="" class="inp form-control" placeholder="Bạn cần tìm gì ?" value="{{request()->search}}">
                </div>
            </form>
...
<style>
    ...
    .content-1:hover .dropdown-content-2{
        display: block;
    }
    .fa-list-ul{
        padding: 4px;
