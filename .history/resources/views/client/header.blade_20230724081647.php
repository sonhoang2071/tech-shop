<div class="">
    ...
    <div class="head2">
        <div class="main-nav">
            ...
            <div class="block-cart nav-item dropdown" aria-labelledby="navbarDropdown" id="menuUser">
                @guest
                @if (Route::has('login'))
                ...
                @else
                        ...
                        <div class="dropdown-menu dropdown-menu-end" id="menuUser-content" >
...
<style>
    ...
    #menuUser:hover #menuUser-content{
            display: block;
    }
    a {
        text-decoration: none;
