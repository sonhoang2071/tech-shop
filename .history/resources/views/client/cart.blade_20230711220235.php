    ...
    <div id="main-cart">
        @if (!empty(Session::has("Cart")))
                    ...
                    <div class="row r-item">
                        ...
                        <div class="col-3">
                            <div class="qty-container">
                                ...
                                <input type="te" name="qty" value="{{$item['quantity']}}" class="input-qty" id="item-cart-{{$item['productInfo']->id}}"/>
                                <button class="qty-btn-plus btn-light" type="button"><i class="fa fa-plus" onclick="decreaseItem({{$item['productInfo']->id}})"></i></button>
                            </div>
                        </div>
            ...
            <div class="content-right">
                ...
                <a href="" class="btn-checkout">Đặt Hàng</a>
            </div>
        @else
