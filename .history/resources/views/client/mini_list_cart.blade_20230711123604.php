@if (!empty(Session::has("Cart")))
    <div class="content-left ">
        ...
        @foreach (Session::get("Cart")->products as $item)
            <div class="row r-item">
                ...
                <div class="col-3">
                    <input type="number" name="" id="" value="{{$item['quantity']}}" style="width:120px" min="1">
                </div>
    ...
    <input id="total-quantity-list-cart" hidden type="number" value="{{Session::get('Cart')->totalQuantity}}">
