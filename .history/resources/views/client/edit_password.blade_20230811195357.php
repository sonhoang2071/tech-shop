                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="new_pass_confirm" type="text" class="form-control @error('new_pass_confirm') is-invalid @enderror" name="new_pass_confirm" value="{{ old('new_pass_confirm')}}" autocomplete="cur_new_pass_confirmpass" autofocus placeholder="Nhập mật khẩu lại hiện tại...">
