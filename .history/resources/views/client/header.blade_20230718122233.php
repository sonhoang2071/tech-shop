            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    @foreach (getAllCateGory() as $item)
                        <a href="{{route('client.getProWith'.$item->tenLoai}})}}" style="display: flex">{{$item->tenLoai}}<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i></a>
                    @endforeach
                </div>
            </div>
