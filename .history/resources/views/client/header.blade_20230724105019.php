            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    @foreach (getAllCateGory() as $item)
                        <a href="{{route('client.getProWith',['cate'=>$item->tenLoai])}}" style="display: flex">{{$item->tenLoai}}<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i></a>
                    @endforeach
                </div>
            </div>
                ...
                @else
                        ...
                        <div class="dropdown-content" id="menuUser-content" >
                            @if (Auth::user()->role == 'admin')
                                <a href="{{route('admin.home')}}" style="">Quản lý<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i></a>
                            @else
                                <a href="" style="display: flex">Tài khoản của bạn<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i></a>
                                <a href="" style="display: flex">Lịch sử đơn hàng<i class="fa-solid fa-angle-right fa-lg" style="height: 20px;line-height: 20px;margin-left: auto;opacity: 0.6;"></i></a>
                            @endif
                            <a href="{{ route('logout') }}"
