...
Route::prefix('admin')->name('admin.')->middleware('admin')->group(function(){
    ...
    Route::prefix('categories')->name('categories.')->group(function(){
        ...
        Route::get('list/add',[CategoriesController::class,'getAdd'])->name('getAdd');
        Route::post('list/add',[CategoriesController::class,'postAdd'])->name('postAdd');
    });
    Route::prefix('brands')->name('brands.')->group(function(){
        Route::get('list',[BrandsController::class,'getList'])->name('list');
        oute::get('list',[BrandsController::class,'getList'])->name('list');
    });
