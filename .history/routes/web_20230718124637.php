...
Route::prefix('/')->name('client.')->group(function(){
    ...
    Route::get('{cate}',[ProductsController::class,'getProWithCate'])->name('getProWith');
    ...
    Route::get('cart/list',[CartController::class,'showCart'])->name('cart');
    Route::get('cart/list/checkOut',[CartController::class,'checkOut'])->name('checkOut');
});
