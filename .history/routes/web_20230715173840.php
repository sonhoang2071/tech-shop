...
Route::prefix('/')->name('client.')->group(function(){
    ...
    Route::get('list/addToCart/{id}',[ProductstController::class,'addToCart'])->name('addToCart');
    Route::get('list/deleteCart/{id}',[ProductsController::class,'deleteItemCart'])->name   ('deleteItemCart');
    Route::get('cart/deleteItemListCart/{id}',[CartController::class,'deleteItemListCart'])->name('deleteItemListCart');
    Route::get('cart/updateItemListCart/{id}/{quantity}',[CartController::class,'updateItemListCart'])->name('updateItemListCart');
