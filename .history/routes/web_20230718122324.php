...
Route::prefix('/')->name('client.')->group(function(){
    ...
    Route::get('smartphone',[ProductsController::class,'getProWithPhone'])->name('getProWithĐiện thoại');
    Route::get('laptop',[ProductsController::class,'getProWithPhone'])->name('getProWithĐiện thoại');
