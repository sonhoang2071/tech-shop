...
Route::prefix('/')->name('client.')->group(function(){
    ...
    Route::get('product/{id}',[ProductsController::class, 'getDetail'])->name('getDetail');
    Route::get('proructaddToCart/{id}',[ProductsController::class,'addToCart'])->name('addToCart');
    ...
    Route::get('checkout',[OrdersController::class,'addOrder'])->name('checkOut');
});
