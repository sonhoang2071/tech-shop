...
class TestController extends Controller
{
    ...
    public function gdata2() {
        return $data = DB::select('SELECT MONTH(orders.created_at) AS mm, SUM(orders.tongTien) AS order_retail_price, SUM(products.giaMua * orderdetail.soLuong) AS order_retail_price
                        FROM orders
